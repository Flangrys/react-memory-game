...
const DifficultyChooser: React.FC = () => {
  ...
  return (
    <Container>
      <MenuContainer>
        <AppName>{document.title}</AppName>

        <MenuContent>
          <DifficultyLabelContainer>
            <DifficultyLabel>
              <DifficultyLabelTitle>Escoge una dificultad:</DifficultyLabelTitle>
              <DifficultyLabelSubtitle>Con cada nivel de dificultad la cantidad de targetas aumentan.</DifficultyLabelSubtitle>
            </DifficultyLabel>

            <SwitchThemesButton onClick={onSwitchThemes} title="Cambiar tema">
